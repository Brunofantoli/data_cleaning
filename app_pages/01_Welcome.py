...
st.page_link("app_pages/04_ConsumptionData.py", label="Consumption Data", icon=":material/attach_money:")
st.page_link("app_pages/05_ImportAnyFile.py", label="Import Any File", icon=":material/all_inclusive:")